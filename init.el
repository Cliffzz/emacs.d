...
`dotspacemacs/user-config' first."
  ;; Fix loading dependencies for gruvbox theme.
  (load-file "~/.emacs.d/elpa/dash-20170810.137/dash.elc")
  (load-file "~/.emacs.d/elpa/autothemer-20170112.1324/autothemer.elc")
  )
